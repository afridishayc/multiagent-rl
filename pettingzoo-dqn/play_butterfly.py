...
#from pettingzoo.utils import observation_saver as save_observation
...
import numpy as np
import pandas as pd
from ray.rllib.models.modelv2 import ModelV2 as Model
from ray.rllib.models.catalog import ModelCatalog
from ray.rllib.models.tf.tf_modelv2 import TFModelV2
from ray.rllib.utils import try_import_tf
import sys
import matplotlib.pyplot as plt
from pettingzoo.butterfly import pistonball_v1 as pistonball_v0
from pettingzoo.butterfly import prospector_v1, knights_archers_zombies_v2, cooperative_pong_v1, prison_v1
...
def save_observation(env, agent=None, all_agents=False, save_dir=os.getcwd(), observations = None):
    if agent is None:
